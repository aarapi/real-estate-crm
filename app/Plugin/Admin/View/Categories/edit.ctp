<div <?php if(!$isError){?>class="container"<?php }?>>
	...
	<div class="panel-heading"><?php echo __('Edit');?> <?php echo __('Category');?><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div>            
                <div class="panel-body"><?php echo $this->Session->flash();?>
                <?php echo $this->Form->create('Category', array( 'controller' => 'Categories','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal'));?>
		  ...
		  <div class="panel-body">
		    <div class="form-group">
			  ...
			  <div class="col-sm-10">
			     <?php echo $this->Form->input("$k.Category.name",array('label' => false,'class'=>'form-control','placeholder'=>'Name','div'=>false));?>
			  </div>
		    </div>
