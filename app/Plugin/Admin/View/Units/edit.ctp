...
<div <?php if(!$isError){?>class="container"<?php }?>>
	...
	<div class="panel-heading"><?php echo __('Edit');?> <?php echo __('Unit');?><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div>            
		  ...
		  <div class="panel-body">
		    <div class="form-group">
			  ...
			  <div class="col-sm-6">
			     <?php echo $this->Form->input("$k.Unit.name",array('label' => false,'class'=>'form-control','placeholder'=>__('Payment Type'),'div'=>false));?>
			  </div>
		    </div>
