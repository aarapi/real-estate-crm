...
<div class="panel"><?php echo $this->Session->flash();?>
    <div class="panel-heading">
        <div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Plans'));?>
	    <?php echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New Plan'),array('controller'=>'Plans','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
...
<?php echo $this->Html->css('print');?>
    <div class="panel-body">
			    ...
			    <td><span class="label label-<?php if($post['Plan']['status']=="Active")echo"success";else echo"danger";?>"><?php echo __($post['Plan']['status']); ?></span></td>
