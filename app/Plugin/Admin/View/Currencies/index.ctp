...
<div class="panel"><?php echo $this->Session->flash();?>
    <div class="panel-heading">
        <div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Currencies')); echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New Currency'),array('controller'=>'Currencies','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
