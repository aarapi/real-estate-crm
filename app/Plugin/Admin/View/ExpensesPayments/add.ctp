    ...
    <div class="panel-heading">
            ...
            <div class="form-group text-left">
                <div class="col-sm-offset-4 col-sm-8">
                    ...
                    <?php echo$this->Html->link('<span class="fa fa-close"></span> '.__('Close'),array('controller'=>'expenses_payments','action'=>'index',$expenseId),array('class'=>'btn btn-danger','escape'=>false));?>
                </div>
            </div>
