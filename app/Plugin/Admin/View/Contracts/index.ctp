...
?>
<div id="resultDiv">
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Contract');?></h1></div></div>
<div class="panel"><?php echo $this->Session->flash();?>
    <div class="panel-heading">
        <div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Contracts'));?>
	    <?php echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New Contract'),array('controller'=>'Contracts','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
    ...
    <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <?php foreach ($Contract as $post):
                        $id=$post['Contract']['id'];?>
                        <tr>
                            <td><?php echo $this->Form->checkbox(false,array('value' => $post['Contract']['id'],'name'=>'data[Contract][id][]','id'=>"DeleteCheckbox$id",'class'=>'chkselect'));?></td>
