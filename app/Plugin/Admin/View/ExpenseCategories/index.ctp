...
?>
<div id="resultDiv">
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Category');?></h1></div></div>
<div class="panel"><?php echo $this->Session->flash();?>
    <div class="panel-heading">
        <div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'expense_categories'));?>
	    <?php echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New Category'),array('controller'=>'expense_categories','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
...
<?php echo $this->Html->css('print');?>
    <div class="panel-body">
			    ...
			    <th><?php echo $this->Paginator->sort('published', __('Status'), array('direction' => 'asc'));?></th>
			    ...
			    <td><span class="label label-<?php if($post['ExpenseCategory']['status']=="Active")echo"success";else echo"danger";?>"><?php echo __($post['ExpenseCategory']['status']);?></span></td>
