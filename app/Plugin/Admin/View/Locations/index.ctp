...
?>
<div id="resultDiv">
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Locations');?></h1></div></div>
<div class="panel"><?php echo $this->Session->flash();?>
    <div class="panel-heading">
        <div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Locations'));?>
	    <?php echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New Location'),array('controller'=>'Locations','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
...
<?php echo $this->Html->css('print');?>
    <div class="panel-body">
			    ...
			    <th><?php echo __('Action');?></th>
                        ...
                        $id=$post['Location']['id'];?>
                        <tr>
                            <td><?php echo $this->Form->checkbox(false,array('value' => $post['Location']['id'],'name'=>'data[Location][id][]','id'=>"DeleteCheckbox$id",'class'=>'chkselect'));?></td>
