...
?>
<div id="resultDiv">
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Payment Type');?></h1></div></div>
<div class="panel"><?php echo $this->Session->flash();?>
    <div class="panel-heading">
        <div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Paymenttypes'));?>
	    <?php echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New Payment Type'),array('controller'=>'Paymenttypes','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));?>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('name', __('Payment Type'), array('direction' => 'asc'));?></th>
                            <th><?php echo __('Action');?></th>
                        </tr>
                        <?php foreach ($Paymenttype as $post):
                        $id=$post['Paymenttype']['id'];?>
                        <tr>
                            <td><?php echo $this->Form->checkbox(false,array('value' => $post['Paymenttype']['id'],'name'=>'data[Paymenttype][id][]','id'=>"DeleteCheckbox$id",'class'=>'chkselect'));?></td>
