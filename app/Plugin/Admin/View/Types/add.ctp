<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Add New Type');?></h1></div></div><div class="panel">
    <div class="panel-heading">
    </div>
                <div class="panel-body"><?php echo $this->Session->flash();?>
                <?php echo $this->Form->create('Type', array( 'controller' => 'Types', 'action' => 'add','name'=>'post_req','id'=>'post_req','class'=>'form-horizontal','type'=>'file'));?>
            ...
            <div class="form-group text-left">
                <div class="col-sm-offset-4 col-sm-6">
                    ...
                    <?php echo$this->Html->link('<span class="fa fa-close"></span> '.__('Close'),array('controller'=>'Types','action'=>'index'),array('class'=>'btn btn-danger','escape'=>false));?>
                </div>
            </div>
