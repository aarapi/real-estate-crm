<?php $currency=$this->Html->image('currencies/'.$currencyName,array('fullBase'=>true));?>
<style type="text/css">
...
<p><font style='padding-left:40px;'><?php echo __('We are please allot you');?> <u><strong><?php echo$deal['PropertiesFlat']['type'];?></strong></u> <?php echo __('bearing no');?>.<u><strong><?php echo$deal['PropertiesFlat']['name'];?></strong></u> <?php echo __('on the');?> <u><strong><?php echo$deal['PropertiesFlat']['floor_no'];?></strong></u> <?php echo __('No');?>. <u><strong>"<?php echo$deal['Property']['name'];?>"</strong></u> <?php echo __('in');?></font>
<?php echo __('complex to be known as');?> <u><strong>"<?php echo$deal['Project']['name'];?>"</strong></u> <?php echo __('to be / being constructed on the property being');?> 
<u><strong><?php echo$deal['Property']['remarks'];?> </strong></u> <?php echo __('for a total consideration of');?> <u><strong> <?php  echo$currency.$this->Number->format($deal['Deal']['total_amount']);?>/-</strong></u> <strong>(<?php echo$this->NumToWord->NumberToWord($deal['Deal']['total_amount']);?>).</strong>
</p></td></tr>
...
<?php echo __('from the date of receipt of this letter. The interest would be charged');?> @ <?php echo$lateFees;?>% <?php echo __('if payment is delayed');?>.
</p></td></tr>
<tr><td colspan="2" valign="top" align="left">
